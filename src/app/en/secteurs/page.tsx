    ...
    <Container className="py-12">
      <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        <div>
          ...
          <p className="mt-3 text-base leading-relaxed text-steel">{centraleAchat.descriptionEn}</p>
        </div>
        <div className="relative aspect-[4/3] overflow-hidden border border-steel-soft/30 lg:aspect-[16/11]">
          <Image
            ...
            alt="GAT team visiting a water retention basin"
            fill
      ...
      <SectionDivider label="Sectors we serve" />
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        {centraleAchatSectors.map((sector) => {
          ...
          return (
            ...
            >
              <h3 className="font-display text-lg font-semibold text-blueprint">{sector.nameEn}</h3>
              <p className="mt-2 text-sm leading-relaxed text-steel">{sector.descriptionEn}</p>
